...
public class TVSeriesData {
    ...
    public static String[][] data = new String[][]{
            ...
            {   "Fairy Tail",
                    ...
                    "Action & Adventure, Animation, Comedy, Aci-Fi & Fantasy",
                    "October 12, 2009",
                    "-"
            },
            {   "Hanna",
    ...
    public static ArrayList<TVSeries> getListData(){
        ArrayList<TVSeries> list = new ArrayList<>();
        for (String[] aData : data) {
            TVSeries tvSeries = new TVSeries();
            tvSeries.setTitle(aData[0]);
            tvSeries.setOverview(aData[1]);
            tvSeries.setUser_score(aData[2]);
            tvSeries.setStatus(aData[3]);
            tvSeries.setOriginal_language(aData[4]);
            tvSeries.setRuntime(aData[5]);
            tvSeries.setPhoto(aData[6]);
            tvSeries.setGenre(aData[7]);
            tvSeries.setDate_released(aData[8]);
            tvSeries.setCrew(aData[9]);
            list.add(tvSeries);
        }
        return list;
    }
